    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si es necesario, puede cerrar todas sus otras sesiones del navegador en todos sus dispositivos. Algunas de sus sesiones recientes se enumeran a continuación; sin embargo, esta lista puede no ser exhaustiva. Si cree que su cuenta ha sido comprometida, también debería actualizar su contraseña.
            </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor, ingrese su contraseña para confirmar que desea cerrar sus otras sesiones del navegador en todos sus dispositivos.
